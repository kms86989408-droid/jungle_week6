...
int main()
{
    ...
    printf("2: Find the sum of all odd numbers in the binary tree. / 2: 이진 트리의 모든 홀수 합 구하기\n");
    printf("0: Quit; / 0: 종료\n");
    ...
    while(c != 0)
    {
        ...
        if( scanf("%d",&c) > 0)
        {
            ...
            case 2:
                ...
                printf("The sum of all odd numbers in the binary tree is: %d. / 이진 트리의 모든 홀수 합입니다.\n",oddValueCount);
                removeAll(&root);
                break;
            case 0:
                removeAll(&root);
