...
int main()
{
    ...
    printf("2: Find the great grandchildren of the binary tree. / 2: 증손자가 있는 노드 찾기\n");
    printf("0: Quit; / 0: 종료\n");
    ...
    while(c != 0)
    {
        ...
        if( scanf("%d",&c) > 0)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                printf("\nThe values stored in all nodes of the tree that has at least one great-grandchild are: / 적어도 한 명의 증손자가 있는 노드의 값은 다음과 같습니다: ");
