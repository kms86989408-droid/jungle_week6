...
int main()
{
	...
	printf("2: Reversed the linked list: / 2: 연결 리스트 뒤집기\n");
	printf("0: Quit: / 0: 종료\n");
	...
	while (c != 0)
	{
		...
		case 1:
			...
			break;
		case 2:
			RecursiveReverse(&(ll.head)); // You need to code this function (이 함수는 직접 구현해야 합니다)
			printf("The resulting linked list after reversed the given linked list is: / 주어진 연결 리스트를 뒤집은 결과: ");
			printList(&ll);
			removeAllItems(&ll);
			break;
		case 0:
