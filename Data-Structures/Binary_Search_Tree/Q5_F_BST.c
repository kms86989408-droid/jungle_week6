...
int main()
{
	...
	printf("2: Print the post-order traversal of the binary search tree; / 2: 이진 탐색 트리의 후위 순회 출력\n");
	printf("0: Quit; / 0: 종료\n");
	...
	while (c != 0)
	{
		...
		case 1:
			...
			break;
		case 2:
			printf("The resulting post-order traversal of the binary search tree is: / 이진 탐색 트리의 후위 순회 결과: ");
			postOrderIterativeS2(root); // You need to code this function (이 함수는 직접 구현해야 합니다)
			printf("\n");
			break;
		case 0:
			removeAll(&root);
...
/* Given a binary search tree and a key, this function
   ...
   이 함수는 이진 탐색 트리와 키를 받아 해당 키를 삭제한 뒤 새로운 루트를 반환합니다. 재귀 함수로 작성하세요. */
BSTNode* removeNodeFromTree(BSTNode *root, int value)
{
	/* add your code here (여기에 코드를 작성하세요) */
}
